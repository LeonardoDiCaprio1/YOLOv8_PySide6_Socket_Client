...
class MessageBox(QMessageBox):
    def __init__(self, *args, title='提示', count=1, time=1000, auto=False, **kwargs):
        ...
        self.setStyleSheet('''
                            QWidget{color:black;
                                    background-color: qlineargradient(x0:0, y0:1, x1:1, y1:1,stop:0.4  rgb(124 , 252, 0),stop:1 rgb(124 252 0));
        ...
        self.closeBtn = self.button(QMessageBox.StandardButton.Close)  
